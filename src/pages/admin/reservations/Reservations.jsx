...
const Reservations = () => {
  ...
  // Mock reservations data with hotel information
  ...
  const calculateSummary = () => {
    ...
    return {
      ...
      totalHotels: new Set(reservations.map(r => r.hotel_id)).size,
  ...
  const handleExport = async (format) => {
    try {
      ...
      if (format === 'csv') {
        ...
        a.href = url;
        a.download = `admin-reservations-${new Date().toISOString().split('T')[0]}.csv`;
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = `admin-reservations-${new Date().toISOString().split('T')[0]}.json`;
        document.body.appendChild(a);
        a.click();
        window.URL.revokeObjectURL(url);
        document.body.removeChild(a);
  ...
  const filteredAndSortedReservations = reservations
    .filter(reservation => {
      ...
      const matchesHotel = hotelFilter === 'all' || reservation.hotel_id === hotelFilter;
      ...
      return matchesSearch && matchesStatus && matchesPaymentStatus && matchesRoomType && matchesDate && matchesHotel;
    })
    .sort((a, b) => {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Manage reservations across all hotels</p>
        </div>
        
        <div className="flex items-center gap-2 flex-wrap">
          <button
            onClick={() => setShowImportModal(true)}
            className="flex items-center gap-2 px-4 py-2.5 text-sm border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-sm transition-shadow">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-3xl font-bold text-gray-900">{summary.totalReservations}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-sm transition-shadow">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-600 mb-1">Active Hotels</p>
              <p className="text-3xl font-bold text-gray-900">{summary.totalHotels}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-sm transition-shadow">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-green-700">₹{summary.totalRevenue.toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-sm transition-shadow">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-red-700">₹{summary.pendingPayments.toLocaleString()}</p>
            </div>
            <div className="p-3 bg-red-50 rounded-lg ml-4">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
              ...
              >
                ...
                <option value="H001">Grand Palace Hotel</option>
                <option value="H002">Ocean View Resort</option>
                <option value="H003">Mountain View Inn</option>
              </select>
            </div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button
              ...
              className="text-sm text-blue-600 hover:text-blue-700 font-semibold self-start sm:self-auto"
            >
              Clear all filters
            </button>
          </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="flex items-center gap-3 flex-1">
          <div className="relative flex-1 max-w-xl">
            ...
            <input
              type="text"
              placeholder="Search by guest, hotel, reservation number..."
              value={searchTerm}
          ...
          <button
            ...
            className="p-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex-shrink-0"
            title="Refresh"
          >
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-6">
              {searchTerm || statusFilter !== 'all'
                ...
                : 'No reservations available in the system'}
            </p>
          </div>
        )}
      </div>
