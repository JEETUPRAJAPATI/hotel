  ...
  const loadAgentData = async () => {
    try {
      ...
      setFormData({
        ...
        role: mockAgent.role,
        commission_percentage: mockAgent.commission_percentage.toString(),
      ...
      setExistingImageUrl(mockAgent.profile_image);
    } catch (error) {
                ...
                <div className="relative">
                  ...
                  {profileImage || existingImageUrl ? (
                    <div className="relative w-40 h-40 mx-auto">
                      <img
                        src={profileImage ? URL.createObjectURL(profileImage) : existingImageUrl}
                        alt="Profile preview"
                      ...
                      <label
                        ...
                        className="absolute bottom-2 right-2 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors cursor-pointer"
                      >
