...
import { managerStaffService, managerDepartmentService } from '../../services/manager/managerService';
...
const StaffManagement = () => {
  ...
  const loadStaff = async () => {
    try {
      setLoading(true);
      const response = await managerStaffService.getStaff({
        ...filters,
  ...
  const loadDepartments = async () => {
    try {
      const response = await managerDepartmentService.getDepartments({
        hotel_id: '60f1b2b3b3b3b3b3b3b3b3b3', // Replace with actual hotel ID
        status: 'Active'
      });
